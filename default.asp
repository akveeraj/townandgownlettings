...
<div class='mainheader' style='padding-left:19px; border-bottom:solid 0px #ffffff; padding-bottom:0px;'>Welcome to Town and Gown Lettings Ltd</div>

<div class='basictext' style='margin-bottom:5px; padding-left:18px; cursor:default;'>
Town and Gown Lettings is a new Oxford based letting agency for working professionals and University goers 
seeking affordable long or shortlet accommodation specifically within the Oxford area. We are an introductory service matching Tenants with Properties.
</div>
...
<div style='display:block; margin-top:0px; margin-left:20px;'>

<img src='/application/library/media/forsale-townandgown.png'/>
</div>
